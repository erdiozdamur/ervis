...
const iconMap = {
  ...
  settings: (
    <>
      ...
      <path
        d="M19.4 15a1.7 1.7 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06A1.7 1.7 0 0 0 15.12 20a1.7 1.7 0 0 0-1.12 1.56V21.7a2 2 0 1 1-4 0v-.09A1.7 1.7 0 0 0 8.88 20a1.7 1.7 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06A1.7 1.7 0 0 0 4.56 15a1.7 1.7 0 0 0-1.56-1.12H2.9a2 2 0 1 1 0-4H3a1.7 1.7 0 0 0 1.56-1.12 1.7 1.7 0 0 0-.33-1.82L4.17 6.88A2 2 0 0 1 7 4.05l.06.06A1.7 1.7 0 0 0 8.88 4a1.7 1.7 0 0 0 1.12-1.56V2.3a2 2 0 1 1 4 0v.09A1.7 1.7 0 0 0 15.12 4a1.7 1.7 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06a1.7 1.7 0 0 0-.33 1.82A1.7 1.7 0 0 0 21 9.44h.09a2 2 0 1 1 0 4H21a1.7 1.7 0 0 0-1.6 1.56Z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
    </>
