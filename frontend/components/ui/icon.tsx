...
const iconMap = {
  ...
  settings: (
    <path
      d="M10.8 5.25h2.4l.42 1.7a5.2 5.2 0 0 1 1.24.71l1.56-.78 1.7 1.7-.78 1.56c.28.39.51.81.7 1.24l1.71.42v2.4l-1.71.42c-.19.43-.42.85-.7 1.24l.78 1.56-1.7 1.7-1.56-.78c-.39.28-.81.52-1.24.71l-.42 1.7h-2.4l-.42-1.7a5.2 5.2 0 0 1-1.24-.71l-1.56.78-1.7-1.7.78-1.56a5.2 5.2 0 0 1-.7-1.24l-1.71-.42v-2.4l1.71-.42c.19-.43.42-.85.7-1.24l-.78-1.56 1.7-1.7 1.56.78c.39-.28.81-.52 1.24-.71l.42-1.7ZM12 14.75a2.75 2.75 0 1 0 0-5.5 2.75 2.75 0 0 0 0 5.5Z"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
  ),
